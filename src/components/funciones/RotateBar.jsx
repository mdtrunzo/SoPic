...
function RotateBar({close, checkClick, rotateFunction, rotateFunction2, rotateFunction3, 
  rotateFunction4, rotateFunction5, rotateFunction6,rotateFunction7, rotateFunction8,
  rotateFunction9, rotateFunction10, rotateFunction11, rotateFunction12}) {
              ...
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction6(e.target.value); rotateAction6(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 7 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction7(e.target.value); rotateAction7(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 8 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction8(e.target.value); rotateAction8(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 9 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction9(e.target.value); rotateAction9(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 10 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction10(e.target.value); rotateAction10(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 11 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction11(e.target.value); rotateAction11(e.target.value)}}></input>   
                </div>   
              )
              : showRotate === 12 ?
              (
                <div className="range-div">
                 <div className="range-div-header">
                  ...
                  <input type="range" className='range' min={-180} max={180} defaultValue={0} onChange={(e) => {rotateFunction12(e.target.value); rotateAction12(e.target.value)}}></input>   
                </div>   
              )
              :
