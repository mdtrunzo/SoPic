...
function Amistad({showRotatePanel}) {
    return (
        <div>
            ...
            <Fade>         
                <div className="texto texto-amistad">
                    <h2>amistad</h2>
                    <h4>[fæmli] noun</h4>
                    <p onClick={showRotatePanel}>Construída sobre la base de la reprocidad y el trato asiduo. Valores fundamentales en una amistad
