...
function CollagesCinco() {
  const [collageCinco, setCollageCinco] = useState(null)
  const {
    getImg1,
    getImg2,
    getImg3,
  ...
  return (
    <div>
      {!collageCinco ? (
        ...
        collageCinco?.template.map((item) => {
          return (
            <Fade>
              <div className="page-template-flex collages-template">
                ...
                <div className="images">
                  {/* Imagen 4 */}
                  <div style={{ overflow: 'hidden' }} className="imagen-central-collage-cinco">
                    <div
                      className="header-img"
                      style={{
